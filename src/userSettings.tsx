...
export const whitelistSettings: WhitelistSettings = {
  ...
  endDate: date("20 Feb 2022 00:00:00 GMT"),
  countdown: true,
  //Example date below
  // date('29 2021 00:00:00 GMT')
  ...
  title: "OG NFT",
  desc: "Must have your wallet verified on discord (https://discord.gg/udderchaos). This NFT will provide utility to the main collection.",
...
export const publicSaleSettings: PublicSaleSettings = {
  ...
  startDate: date("30 Feb 2022 00:00:00 GMT"),
  endDate: undefined,
  countdown: false,
  //Example date below
  // date('29 2021 00:00:00 GMT')
